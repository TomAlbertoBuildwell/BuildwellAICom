            ...
            <ContainerScroll
                titleComponent={
                    <div className="relative z-10 mx-auto max-w-4xl text-center mb-20 md:mb-40">
                        <h1 className="font-display text-balance text-4xl font-bold md:text-5xl lg:text-6xl text-foreground dark:text-white mb-6">
                            Your AI-Powered{" "}
            ...
            >
                <div className="relative w-full h-full">
                    ...
                    <Image
                        ...
                        src="/screenshots/chat_screenshot.jpeg"
